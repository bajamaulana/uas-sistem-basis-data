        ...
        <div class="menu-grid">
            ...
            <ul class="menu-list">
              ...
              <a href =""><li class="menu-item">
                <div>
                  ...
                  <p class="item-desc">kopi hitam dari espresso dan air panas dengan rasa kuat dan sederhana.</p>
                </div>
              ...
              <li class="menu-item">
                <div>
                  ...
                  <p class="item-desc">Kopi beraroma karamel dan vanila yang kaya.</p>
                </div>
                <span class="item-price">20k</span>
              </li>
              ...
              <li class="menu-item">
                <div>
                  ...
                  <p class="item-desc">Kopi espresso dengan busa susu lembut di atasnya.</p>
                </div>
          ...
          <div class="menu-column">
            <ul class="menu-list">
              <li class="menu-item">
                <div>
                  <span class="item-name">Brownies</span>
                  <p class="item-desc">Potongan brownies cokelat lembut dengan rasa kaya.</p>
                </div>
              ...
              <li class="menu-item">
                <div>
                  ...
                  <p class="item-desc">Roti lapis renyah dengan mentega yang menggoda.</p>
                </div>
              ...
              <li class="menu-item">
                <div>
                  ...
                  <p class="item-desc">Perpaduan lembut teh hijau premium dengan susu creamy hangat.</p>
                </div>
